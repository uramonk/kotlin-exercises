...
class MessageService(
    ...
    fun threadsSearch(
        ...
        query.flatMapLatest {
            messageRepository.searchThreads(it)
        }
    ...
    // 非同期
        // threadsのリストが同時に流れていく
        threads.flatMapMerge(concurrency = Int.MAX_VALUE) {
    ...
    // 同期的
        // messagesのリストが一つずつ流れていく
        messages.flatMapConcat {
            messageRepository.sendMessages(it)
        }
}
